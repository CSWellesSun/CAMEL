    ...
    for question in tqdm(questions):
        ...
        for i in range(num_choices):
            ...
            for j in range(len(question["turns"])):
                ...
                if len(input_ids[0]) > length_start and len(input_ids[0]) < length_end:
                    turns.append(output)
                    idxs.append(int(idx))
                    new_tokens.append(int(new_token))
                    wall_time.append(total_time)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--length-start", type=int, default=0)
    parser.add_argument("--length-end", type=int, default=4096)
